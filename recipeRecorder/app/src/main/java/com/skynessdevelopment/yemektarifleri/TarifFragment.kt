package com.skynessdevelopment.yemektarifleri
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if(gelenBilgi.equals("menudengelen")){
                // Yeni bir yemek eklemeye geldi
                editText1.setText("")
                editText2.setText("")
                button.visibility = View.VISIBLE

                val gorselSecimArkaPlani = BitmapFactory.decodeResource(context?.resources, R.drawable.grsl)
                ...
                context?.let {
                    ...
                    try {
                        ...
                        while (cursor.moveToNext()){
                            editText1.setText(cursor.getString(yemekIsmiIndex))
                            editText2.setText(cursor.getString(yemekMalzemeIndex))
    ...
    fun kaydet(view: View){
        ...
        val yemekIsmi = editText1.text.toString()
        val yemekMalzeme = editText2.text.toString()
